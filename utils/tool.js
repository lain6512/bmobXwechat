...
function isRecordedToday(timeName,isRecord) {
  ...
  time0Str = dateToString(now).substring(0,10) + ' 04:0:00'
  time0Str_2 = time0_2 + ' 04:00:00'

  time2Str = dateToString(now);
  // console.log("time0Str  ："+time0Str)
  // console.log("time0Str_2："+time0Str_2)
  // console.log("time2Str  ："+time2Str)

  var t0 = TimeDifference(time0Str, time2Str);//当前时间和4点的时间差
  var t0_2 = TimeDifference(time0Str, time2Str);//当前时间和第二天4点的时间差
  // var t1 = TimeDifference(time0Str_2, time1Str);//上一次记录时间和4点的时间差
